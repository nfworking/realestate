    ...
    return (
        <div className='flex flex-col justify-between lg:flex-row gap-16 lg:items-center'>
            ...
            <div className='flex flex-col gap-4 lg:w-2/4'>
                <div>
                    <span className=' text-violet-600 font-semibold'>Casa Mexicali</span>
                    <h1 className='text-3xl font-bold'>5 bedrooms · 3 bathrooms · Heated Pool</h1>
                </div>
...
The lounge and TV room have views to the outdoor heated pool and waterfront, these spaces merge together with the BBQ area and undercover outdoor lounge and dining. You can also access the outdoor area from the Pool Table and Games room.
                ...
                <div className='flex flex-row items-center gap-12'>
                    ...
                    <button className='bg-violet-800 text-white font-semibold py-3 px-16 rounded-xl h-full'>Enquire Now!!</button>
                    <button className='bg-violet-800 text-white font-semibold py-3 px-16 rounded-xl h-full'>Add to Wishlist</button>
                </div>
            </div>
        </div>
    )
